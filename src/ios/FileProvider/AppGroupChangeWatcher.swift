...
final class AppGroupChangeWatcher {
    ...
    private let queue = DispatchQueue(label: "com.claudio.app.fpwatcher", qos: .utility)
    private let domainIdentifier = NSFileProviderDomainIdentifier("com.claudio.app.files")
