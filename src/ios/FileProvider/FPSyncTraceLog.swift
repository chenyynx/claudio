...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.claudio.app.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.claudio.app.FileProvider", category: "FPSyncTrace")
