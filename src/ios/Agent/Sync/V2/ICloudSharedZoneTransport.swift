...
final class ICloudSharedZoneTransport: NSObject, SyncTransport {
    ...
    private static let etagFlushQueue = DispatchQueue(label: "com.claudio.sync.etagFlush", qos: .utility)
    ...
    private func scheduleRecentFetchTimer() {
        ...
        let t = DispatchSource.makeTimerSource(queue: DispatchQueue(label: "com.claudio.sync.recentFetch", qos: .utility))
