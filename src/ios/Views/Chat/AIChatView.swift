...
struct AIChatView: View {
    ...
    /// from SOUL.md (`name`), falls back to "Claudio". Refreshed on .soulMdChanged.
    ...
    var body: some View {
        ...
        // 收敛到 RemoteFilePeekPresentationModifier,避免 body 复杂
        // 触发 type-check 超时(AIChatView.swift:564 反复超时挂 CI)。
